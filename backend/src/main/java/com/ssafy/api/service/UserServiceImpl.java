...
<<<<<<< backend/src/main/java/com/ssafy/api/service/UserServiceImpl.java
...
public class UserServiceImpl implements UserService {
    ...
    public User createUser(UserRegisterPostReq userRegisterInfo) {
        ...
        if (userRegisterInfo.getType() == ProviderType.LOCAL) {
            if (userRegisterInfo.getPassword() == null) throw new InvalidValueException(ErrorCode.INVALID_TYPE_VALUE);
